...
async def help(message: types.Message):
    await message.reply("Всё работает !\n Команд: \n"
                        ...
                        "/crypto - Курс всех криптовалют(вводишь эту команду и через пробел название криптовалюты на англ. яз. с маленькой буквы. пример: '/crypto bitcoin') ")
...
async def crypta(message: types.Message):
    await message.reply("Криптовалюта? Выбирай из трёх вариантов.", reply_markup=inline_kb_crypta)
